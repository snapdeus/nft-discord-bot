...
module.exports = {
  ...
  async execute(client) {
    ...
    do {
      let url = `${ openseaEventsUrl }?collection_slug=${ process.env.COLLECTION_SLUG_FIM }&event_type=created&only_opensea=false&occurred_before=${ newTimestamp }${ next == null ? '' : `&cursor=${ next }` }`;
      try {
